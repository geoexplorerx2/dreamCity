    ...
    return (
        <Fade bottom>
            <section id='locations' className='py-14 relative'>
                ...
                />
                <div className='flex flex-row justify-between container px-[100px]'>
                    <div className="min-w-[623px] max-w-[623px] min-h-[354px] max-h-[354px] overflow-visible relative">
                        <div className="w-full mt-4 xl:mt-0 xl:w-full xl:h-full flex justify-end items-end">
                            <UiSlider
                                style={{
                                    // @ts-ignore
                    ...
                    <div className='relative w-full flex flex-col items-end'>
                        <Fade left cascade>
                            <h1 className={`text-primary  text-right font-medium font-poppins
                                ${defaultImages[activeIndex].label?.split(' ').length > 2 ? 'text-[44px] leading-10' : 'text-[50px]'}
                            `}>
                               {defaultImages[activeIndex].label}
                            </h1>
                        </Fade>
                        <div className='max-w-[393px] min-h-[220px] mt-5 mb-[168px] space-y-5 text-right'>
                        ...
                        {isDomLoaded && !isMobile &&
                            <Fade bottom>
                                <div className="thumbs_slider absolute bottom-0 right-0 w-[580px] h-[100px]">
                                    <UiSlider
                                        // @ts-ignore
                                        spaceBetween={10}
