  ...
  return (
    ...
    >
      ...
      {/* <UiImage
        ...
        className='z-20'
      /> */}
      <div className="absolute top-0 left-0 w-full h-full z-20 bg-[linear-gradient(45deg,_#09101E_0%,_rgba(12,_28,_43,_0.00)_73.44%)]"></div>
      {isDomLoaded && (
        <div className="w-full h-full absolute z-30 flex justify-center text-white">
          <div className="container">
            ...
            <div className="max-w-[287px] lg:max-w-none ml-5 lg:ml-24 text-sm w-[405px] font-extralight mt-5">
              <Fade left cascade>
                Dream City is an exciting new Visual Novel game that combines
                adventure, romance, and drama.
              </Fade>
            </div>
            <Fade left cascade>
              <div className="ml-5 lg:ml-20 w-[390px] flex flex-col justify-between mt-5 lg:mt-20 space-y-4">
                <Button
                  Name={"WATCH TRAILER"}
                  ButtonStyle={
