        ...
        <div className="container h-full flex flex-col-reverse lg:flex-row px-6 lg:px-0">
            ...
            <div className="flex lg:hidden lg:mt-6 mt-11 lg:ml-10">
              <div className="w-full flex justify-between">
                <Button
                  Name={"WATCH TRAILER"}
                  ButtonStyle={
                    "w-40 px-3 py-4 flex items-center rounded-3xl text-xs font-medium bg-gradient-to-r from-[#6E7A8A] to-[rgba(0,0,0,0.5)] text-white"
                  }
              ...
              <div className="">
                <Button
                  Name={"BUY NOW"}
                  ButtonStyle={
                    "w-40 flex justify-center px-3 py-4 flex items-center rounded-3xl text-xs font-medium bg-gradient-to-r from-[#D33535] to-[rgba(211,53,53,0.7)]  text-white"
                  }
          ...
          <div className="text-white flex lg:inline-block flex-col items-center">
            ...
            <div className="w-64 ml-10 mt-6 lg:mt-4 text-sm font-light text-center lg:text-start">
              <Fade cascade left>
                The game follows the story of a high school student who has
                experienced a traumatic event in his life.
              </Fade>
            </div>
            <Fade right cascade>
              <div className="hidden lg:flex mt-11 lg:ml-10">
                <div className="mr-8">
                  <Button
                    Name={"WATCH TRAILER"}
                    ButtonStyle={
                      "w-40 px-3 py-4 flex items-center rounded-3xl text-xs font-medium bg-gradient-to-r from-[#6E7A8A] to-[rgba(0,0,0,0.5)]"
                    }
                    Icon={<Play className="text-gray ml-[0.2rem]" />}
                    IconStyle={`flex justify-center items-center bg-white w-4 h-4 rounded-full ml-3`}
                    link={`https://www.youtube.com/watch?v=nz7bB-QtSgY`}
                ...
                <div className="">
                  <Button
                    Name={"BUY NOW"}
                    ButtonStyle={
                      "w-40 flex justify-center px-3 py-4 flex items-center rounded-3xl text-xs font-medium bg-gradient-to-r from-[#D33535] to-[rgba(211,53,53,0.7)]"
                    }
                    Icon={<Play className="text-primary ml-[0.1rem]" />}
                    IconStyle={`flex justify-center items-center bg-white w-4 h-4 rounded-full ml-3`}
                  />
