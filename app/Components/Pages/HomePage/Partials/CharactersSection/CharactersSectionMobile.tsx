...
interface CharacterSectionDataType {
    id: string, thumb: string, img: string, alt: string, title: string, description: string, bgImage: string, className?: string
}
...
//     </h1>)
// }
const CharactersSectionMobile: FC<CharactersSectionPropsType> = (props) => {
    ...
    return (
        <Fade bottom >
            <section id='characters-slider' className='px-[34px] lg:px-[100px] py-[34px] relative'>
                ...
                <div className='container '>
                    <div className='relative w-full lg:max-h-[636px]'>
                        <Fade bottom>
                            <h1 className='text-primary text-[32px] lg:text-[50px] font-medium font-poppins mb-[200px] text-center lg:text-left'>
                                {charactersData[activeIndex].title}
                            </h1>
                        </Fade>
                        <div className="lg:min-w-[444px] max-w-[444px] lg:min-h-[444px] max-h-[409px] lg:max-h-[636px] overflow-visible relative mx-auto">
                        <div className="w-full mt-4 xl:mt-0 xl:w-full xl:!h-[636px] aspect-2 md:aspect-1 flex justify-end items-end">
                            ...
                            >
                                ...
                                {charactersData.map((imageObj, index) => {
                                    const { alt, thumb, id, img, className } = imageObj
                                    return (
                                        <UiSlider.Slide key={id} className='flex items-end' >
                                            <div className='w-full flex justify-center !h-[409px]'>
                                                {index === 0 ? <Fade bottom>
                                                    <div className="relative w-[268px] flex items-end">

                                                        <UiImage
                                                            className="rounded-lg w-full lg:w-auto max-w-none lg:h-[634px] max-h-[634px]"
                                                            src={img}
                                                            alt={alt}
                                                            width={290}
                                                            height={409}
                                                    ...
                                                    <div className="relative w-[70%] h-full flex items-end">
                                                        ...
                                                        <UiImage
                                                            className={`rounded-lg ${className} lg:w-auto max-w-none lg:h-[634px] max-h-[409px] w-[${210}]`}
                                                            src={img}
                                                            alt={alt}
                                                            width={155}
                                                            height={409}
            ...
            /> */}
                        ...
                        <div className='w-full text-center line-clamp-[16] mt-5 mb-10 space-y-5'>
                            <Fade bottom>
                        ...
                        {isDomLoaded &&
                            <div className="thumbs_slider absolute top-[90px] left-0 w-full h-[100px]">
                                <UiSlider
                                    // @ts-ignore
                                    spaceBetween={10}
                                    onSwiper={(e) => {
...
CharactersSectionMobile.displayName = "CharactersSectionMobile"
